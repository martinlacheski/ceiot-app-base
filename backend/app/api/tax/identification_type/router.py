...
@router.post("/", response_model=IdentificationTypeRead, status_code=status.HTTP_201_CREATED, dependencies=[Depends(PermissionChecker("identification_type:create"))])
...
@router.get("/", response_model=dict, dependencies=[Depends(PermissionChecker("identification_type:read"))])
...
@router.get("/{item_id}", response_model=IdentificationTypeRead, dependencies=[Depends(PermissionChecker("identification_type:read"))])
...
@router.put("/{item_id}", response_model=IdentificationTypeRead, dependencies=[Depends(PermissionChecker("identification_type:update"))])
...
@router.delete("/{item_id}", dependencies=[Depends(PermissionChecker("identification_type:delete"))])
